"""
Django settings for black_feather_dev_95979 project.
...
ROOT_URLCONF = 'black_feather_dev_95979.urls'
...
WSGI_APPLICATION = 'black_feather_dev_95979.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_feather_dev_95979 API",
    "DESCRIPTION": "API documentation for black_feather_dev_95979 App",
    "VERSION": "v1",
}
